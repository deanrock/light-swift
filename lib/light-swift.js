...
(function() {
  ...
  LightSwift = (function() {
    ...
    LightSwift.prototype.addAccount = function(account) {
      var _this = this;
      return this.backend.getAccount(account).then(function(existing) {
        var accountInfo;
        if (existing != null) {
          return;
        }
        ...
        return _this.backend.addAccount(account, accountInfo);
      });
    };
    ...
    LightSwift.prototype.addUser = function(account, username, key) {
      var _this = this;
      return this.backend.getUser(account, username).then(function(existing) {
        if (existing != null) {
          return;
        }
        return _this.backend.addUser(account, username, key);
      });
    };
    ...
    LightSwift.prototype.addAuthToken = function(account, authToken) {
      var _this = this;
      if (!authToken) {
        return;
      }
      return this.backend.getAuthTokenAccount(authToken).then(function(existing) {
        if (existing != null) {
          return;
        }
        return _this.backend.addAuthToken(account, authToken).then(function() {
          return authToken;
        });
      });
    };
    ...
    LightSwift.prototype.addContainer = function(account, container, metadata, acl) {
      ...
      return this.backend.getContainer(account, container).then(function(existing) {
        if (existing != null) {
          return;
        }
        return _this.backend.addContainer(account, container, containerInfo).then(function() {
