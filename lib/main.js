...
(function() {
  ...
  swift.connect().then(function() {
    ...
    return swift.addAuthToken(argv.account, argv.authToken);
  }).then(function() {
    if (argv.container) {
